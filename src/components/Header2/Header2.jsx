    ...
    return(
        <nav className='header2'>
            <div className='header2-contents'>
                <Link to={'/'}><img className='logo2' src={'../../MakeMyTrip logo blue.png'} alt="MakeMyTrip" /></Link>
                <div className='pages-link2'>
                    <NavLink className={'page-link2'} to={'/flights'}><GiCommercialAirplane /> Flights</NavLink>
